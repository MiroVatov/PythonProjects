...
class Goalkeeper(BasePlayer):
    ...
    def __init__(self, name: str, height: int, weight: int, salary: int, contract_expiry_date: str, stamina: int, transfer_fee: int, handling: int, reflexes: int, jumping: int):
